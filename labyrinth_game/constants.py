ROOMS = {
    ...
    'trap_room': {
        ...
        'puzzle': ('Система плит активна. Чтобы пройти,\
                    назовите слово "шаг" три раза подряд\
    ...
    'kitchen': {
        'description': 'По особому уютная кухня. Кажется, вы видите яблочный пирог. \
            Стоит ли его съесть?',
        'exits': {'east': 'library'},
    ...
    'bedroom':{
        'description': 'Спальня... Спальня?! Что в подземелье делает спальня? \
            Видимо, разработчику не хватает креатива.',
        'exits': {'west': 'hall'},
        'items': [],
        'puzzle': None
    }
