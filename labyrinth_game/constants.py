...
"Назовите число, которое идет после девяти". Введите ответ цифрой или словом.',
            "10",
        ),
    },
    "trap_room": {
...
(подсказка: это число пятикратного шага, 2*5= ? )",
    ...
    "kitchen": {
        "description": "По особому уютная кухня.\
Кажется, вы видите яблочный пирог. Стоит ли его съесть?",
        "exits": {"east": "library"},
        "items": ["strange_apple_pie"],
        "puzzle": None,
    },
    "bedroom": {
        "description": "Спальня... Спальня?!\
Что в подземелье делает спальня? Видимо, разработчику не хватает креатива.",
        "exits": {"west": "hall"},
        "items": [],
        "puzzle": None,
    },
