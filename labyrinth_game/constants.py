ROOMS = {
    ...
    'hall': {
        ...
        'items': [],
        'puzzle': ('На пьедестале надпись: "Назовите число, которое идет после девяти". Введите ответ цифрами.', '10')
    },
    'trap_room': {
    ...
    'library': {
        ...
        'exits': {'east': 'hall', 'north': 'armory', 'west':'kitchen'},
        'items': ['ancient_book'],
    ...
    'kitchen': {
        'description': 'По особому уютная кухня. Кажется, вы видите яблочный пирог. Стоит ли его съесть?',
        'exits': {'east': 'library'},
        'items': ['strange_apple_pie'],
        'puzzle': None
    },
    'bedroom':{
        'description': 'Спальня... Спальня?! Что в подземелье делает спальня? Видимо, разработчику не хватает креатива.',
        'exits': {'west': 'hall'},
        'items': [],
        'puzzle': None
    }
